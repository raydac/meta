...
public enum Complexity {
  ...
  /**
   * <a href="https://en.wikipedia.org/wiki/Iterated_logarithm">Iterated logarithmic.</a> Example: <a href="https://en.wikipedia.org/wiki/Graph_coloring#Parallel_and_distributed_algorithms">Distributed coloring of cycles.</a>
   * <p><b>O(log* n)</b></p>
   */
   ...
   * <p><b>O(n<sup>c</sup>) where 0 < c < 1 </b></p>
   */
   ...
   * <p><b>O(n<sup>3</sup>)</b></p>
   */
  CUBIC("O(n^3)"),
  /**
   * <a href="https://en.wikipedia.org/wiki/Time_complexity#Polynomial_time">Polynomial</a>. Example: <a href="https://en.wikipedia.org/wiki/Karmarkar's_algorithm">Karmarkar's algorithm for linear programming</a>; AKS primality test.
   * <p><b>2<sup>O(log n)</sup> = poly(n)</b></p>
   */
  POLYNOMIAL("poly(n)"),
  /**
   ...
   * SUBEXP.
   * <p><b>O(2<sup>n<sup>ε</sup></sup>) for all ε > 0</b></p>
   */
   ...
   * arithmetic.
   * <p><b>2<sup>2<sup>poly(n)</sup></sup></b></p>
   */
  DOUBLE_EXPONENTIAL("2^2^poly(n)");
  
  private final String formula;
  
  private Complexity(final String formula) {
