...
public class Risky extends AbstractMetaAnnotationProcessor {
  ...
  protected int doProcessing(final Context context, final JavaClass javaClass,
    ...
    context.warning("is marked as risky" + addSemicolonIfNeeded(text), true);
    return 1;
  }

  @Override
  public List<Class<? extends Annotation>> getProcessedAnnotationClasses() {
    return List.of(com.igormaznitsa.meta.annotation.Risky.class);
  }
